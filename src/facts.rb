...
choices = { Cat: 0, Shark: 1, Spider: 2, Snake: 3, Bird: 4, Maggot: 5, Bat: 6, Wasp: 7, Hyena: 8, Pig: 9, Wolf: 10, Vulture: 11, Cockroach: 12, Rat: 13, Skunk: 14, Orca: 15, Pigeon: 16, Piranha: 17, Frog: 18, Bull: 19 }

Answer = prompt.select('What animal would you like to learn about?', choices)
